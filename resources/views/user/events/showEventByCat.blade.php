...
<main class="space-y-40 mb-10">
    ...
    <div class="flex items-center justify-between flex-wrap px-20 pt-36">

        <a href="{{route('user.events.category', ['id' => 11])}}">
        ...
        <a href="{{route('user.events.category', ['id' => 10])}}">
            <div class="flex flex-col items-center gap-2">
                <div class="border border-blue-100 rounded-full p-8  hover:bg-blue-100">
        ...
        <a href="{{route('user.events.category', ['id' => 12])}}">
            <div class="flex flex-col items-center gap-2">
                <div class="border border-blue-100 rounded-full p-8  hover:bg-blue-100">
        ...
        <a href="{{route('user.events.category', ['id' => 13])}}">
            <div class="flex flex-col items-center gap-2">
                <div class="border border-blue-100 rounded-full p-8  hover:bg-blue-100">
        ...
        <a href="{{route('user.events.category', ['id' => 17])}}">
            <div class="flex flex-col items-center gap-2">
                <div class="border border-blue-100 rounded-full p-8  hover:bg-blue-100">
        ...
        <a href="{{route('user.events.category', ['id' => 8])}}">
            <div class="flex flex-col items-center gap-2">
                <div class="border border-blue-100 rounded-full p-8  hover:bg-blue-100">
        ...
        <a href="{{route('user.events.category', ['id' => 16])}}">
            <div class="flex flex-col items-center gap-2">
                <div class="border border-blue-100 rounded-full p-8  hover:bg-blue-100">
    ...
    <div>
        <div class="relative max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            ...
            <div class="mb-12 space-y-2 text-center">
                <h2 class="text-3xl font-bold text-gray-800 md:text-4xl dark:text-white">{{$category->name}} Events</h2>
            </div>
