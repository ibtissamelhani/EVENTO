        ...
        <div class="grid grid-cols-3 gap-4 mb-4">
            <div class="flex items-center justify-center h-20 rounded bg-indigo-100 dark:bg-indigo-300">
                <p class="text-2xl text-blue-800 font-bold dark:text-gray-500">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap"><span class="mr-4">{{ $countCat }}</span>Event
                        Categories</span>
                </p>
            </div>
            <div class="flex items-center justify-around h-20 rounded bg-gray-50 dark:bg-gray-800 col-span-2">

                <form class="flex items-center max-w-sm" method="GET" action="{{ route('admin.categories.search') }}">
                    @csrf
                ...
                <div id="crud-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <!-- Modal body -->
                            <form class="p-4 md:p-5" method="POST" action="{{ route('admin.category.store') }}">
                                @csrf
