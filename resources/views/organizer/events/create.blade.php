        ...
        <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
            <form action="{{ route('organizer.MyEvents.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        <label for="name" class="text-blue-700 font-semibold">Name</label>
                        <input class="w-full rounded-lg border-gray-200 p-3 text-sm" name="name" placeholder="Name"
                            type="text" id="name" />
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>

                    <div>
                        <label for="phone" class="text-blue-700 font-semibold">Location</label>
                        <input class="w-full rounded-lg border-gray-200 p-3 text-sm" name="location"
                            placeholder="Event location" type="text" id="phone" />
                ...
                <div class="grid grid-cols-1 gap-4 text-center sm:grid-cols-3">
                    <div>
                        ...
                        <input id="date" type="date"
                            ...
                            placeholder="Date" min="{{ \Carbon\Carbon::now()->toDateString() }}" />
